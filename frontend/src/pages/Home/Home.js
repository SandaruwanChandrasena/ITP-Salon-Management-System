    ...
    <div className="home">
      <nav className="container --flex-between">
        ...
        <div className="additional-buttons">
          <ul className="home-links" >
            <li>
              <button className="--btn --btn-secondary" style={{width:"70px"}}>Service</button>
            </li>
            <li>
              <button className="--btn --btn-secondary">
                <Link to="/createBooking" style={{width:"130px"}}>Book Appointment</Link>
              </button>
            </li>
            ...
            <li>
              <button className="--btn --btn-secondary" style={{width:"110px"}}>
                <Link to="/az">Job Vacancy</Link>
              </button>
            </li>

            <li>
            <button className="--btn --btn-secondary" style={{width:"90px"}}>
      ...
      <footer className="footer">
        <div className="container">
          <p>
            &copy; 2024 Your Company. All rights reserved. Made with{" "}
